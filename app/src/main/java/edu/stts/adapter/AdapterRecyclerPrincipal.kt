...
class AdapterRecyclerPrincipal (val context: Context?, var dataItems: ArrayList<ResultItem?>?,
                                private val listener: (ResultItem?) -> Unit):
    RecyclerView.Adapter<AdapterRecyclerPrincipal.itemHolder>(), AnkoLogger {
